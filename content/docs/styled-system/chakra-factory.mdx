...
Chakra factory serves as an **object of chakra enabled JSX elements**, and also as
 **a function that can be used to enable a custom component** to receive chakra's
style props.
